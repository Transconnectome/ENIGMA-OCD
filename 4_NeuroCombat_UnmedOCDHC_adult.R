...
# train set
write.csv(train_harmo, file="Adult_UnmedOCDHC_train_harmo.csv")
write.csv(train_harmo.cov_as, file="Adult_UnmedOCDHC_train_harmo_cov.csv")

# test set
write.csv(test_harmo, file="Adult_UnmeOCDHC_test_harmo.csv")
write.csv(test_harmo.cov_as, file="Adult_UnmedOCDHC_test_harmo_cov.csv")
