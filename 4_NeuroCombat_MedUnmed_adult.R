...
# test set
write.csv(test_harmo, file="Adult_MedUnmed_test_harmo.csv", row.names = F, na = "")
write.csv(test_harmo.cov_as, file="Adult_MedUnmed_test_harmo_cov.csv", row.names = F, na = "")
